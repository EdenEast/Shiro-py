...
class KScrollAreaViewer(QScrollArea):
    def __init__(self, parent = None):
        super(KScrollAreaViewer, self).__init__(parent)
    ...
    def mousePressEvent(self, *args, **kwargs):
        ...
        super(KScrollAreaViewer, self).mousePressEvent(*args, **kwargs)
    ...
    def mouseMoveEvent(self, *args, **kwargs):
        if self.drag_mouse:
            ...
            self.drag_position['x'] = args[0].x()
            self.drag_position['y'] = args[0].y()
        super(KScrollAreaViewer, self).mouseMoveEvent(*args, **kwargs)
